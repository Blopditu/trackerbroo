...
- Tracker Broo is for a small friend group logging protein, gym consistency, and progress quickly, often on mobile.
- Optimize for speed, clarity, calm feedback, and readable graphs.
- Avoid loud/gamified UI. Red should remain mostly error-only.
