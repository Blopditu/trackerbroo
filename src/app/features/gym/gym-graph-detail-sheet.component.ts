      ...
      <div class="sheet-stack">
        ...
        <div class="grid-two">
          <mat-form-field class="m3-field" appearance="outline" subscriptSizing="dynamic">
            ...
            <input
              ...
              type="date"
              [value]="detailFrom()"
              (input)="dateChange.emit({ type: 'from', value: valueOf($event) })"
            />
          </mat-form-field>
          <mat-form-field class="m3-field" appearance="outline" subscriptSizing="dynamic">
            ...
            <input
              ...
              type="date"
              [value]="detailTo()"
              (input)="dateChange.emit({ type: 'to', value: valueOf($event) })"
            />
          </mat-form-field>
        </div>
        <div class="progress-range" role="group" aria-label="Zeitraum für Detailgraph">
          ...
          <button
            ...
            type="button"
            class="progress-range-btn"
            (click)="setRangeDays.emit(365)"
          >
            365 Tage
          </button>
        </div>
        <button mat-flat-button type="button" class="action-btn ghost" (click)="reload.emit()">
          Neu laden
        </button>
