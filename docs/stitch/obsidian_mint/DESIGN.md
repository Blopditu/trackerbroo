...
### Input Fields
*   **The Minimalist Input:** A solid block of `surface_container_highest` with a `rounded-md` (0.75rem) corner. The label sits *above* the field in `label-sm` uppercase. The cursor should always be the `primary` color.
