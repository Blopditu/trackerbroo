...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS track_steps BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS daily_steps_target INTEGER NOT NULL DEFAULT 8000;
